...
export function highlighting(dicts, dataset, categories, shaping_column, columns, category_search, category_search_data, feature_column, color_column, color, needZoom, transparent_column, val_opacityMatch, val_opacityNoMatch) {
